...
namespace System.Net.Http.QPack
{
	internal static class H3StaticTable
	{
		...
		public static IReadOnlyDictionary<int, int> StatusIndex
		{
			get
			{
				throw null;
		...
		public static IReadOnlyDictionary<HttpMethod, int> MethodIndex
		{
			get
			{
				throw null;
		...
		public static HeaderField GetHeaderFieldAt(int index)
		{
			throw null;
		}
	}
